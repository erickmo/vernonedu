...
class AppColors {
  ...
  // Role colors
  static const Color roleDirector = Color(0xFF4A148C);
  static const Color roleDeptLeader = Color(0xFF1565C0);
  static const Color roleCourseOwner = Color(0xFF00695C);
  static const Color roleFacilitator = Color(0xFF558B2F);
  static const Color roleCS = Color(0xFF6A1B9A);
