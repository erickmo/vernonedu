...
func (r *BranchRepository) Save(ctx context.Context, b *branch.Branch) error {
	query := `
		INSERT INTO branches (id, name, city, address, partner_id, partner_name, is_active, created_at, updated_at)
		VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
	`
	_, err := r.db.ExecContext(ctx, query,
		b.ID, b.Name, b.City, b.Address, b.PartnerID, b.PartnerName, b.IsActive,
...
func (r *BranchRepository) Update(ctx context.Context, b *branch.Branch) error {
	query := `
		UPDATE branches SET name=$1, city=$2, address=$3, partner_id=$4, partner_name=$5,
		is_active=$6, updated_at=$7 WHERE id=$8
	`
	_, err := r.db.ExecContext(ctx, query,
		b.Name, b.City, b.Address, b.PartnerID, b.PartnerName, b.IsActive,
		time.Now(), b.ID,
	)
	if err != nil {
...
func (r *BranchRepository) GetByID(ctx context.Context, id uuid.UUID) (*branch.Branch, error) {
	...
	query := `SELECT id, name, city, address, partner_id, partner_name, is_active, created_at, updated_at FROM branches WHERE id = $1`
...
func (r *BranchRepository) List(ctx context.Context, offset, limit int) ([]*branch.Branch, int, error) {
	...
	query := `SELECT id, name, city, address, partner_id, partner_name, is_active, created_at, updated_at FROM branches ORDER BY name ASC LIMIT $1 OFFSET $2`
