...
type ReadRepository interface {
	...
	List(ctx context.Context, offset, limit int, search, sortBy, sortDir string) ([]*CourseBatch, int, error)
	ListEnriched(ctx context.Context, offset, limit int, search, sortBy, sortDir string) ([]*EnrichedCourseBatch, int, error)
