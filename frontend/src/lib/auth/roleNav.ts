...
const INTERNAL_DOMAINS: DomainGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/internal/finance/reports/balance-sheet', label: 'Balance Sheet', allowedRoles: ['ceo', 'admin', 'director', 'accounting_leader'] },
      { to: '/internal/finance/reports/profit-loss', label: 'Profit & Loss', allowedRoles: ['ceo', 'admin', 'director', 'accounting_leader'] },
      { to: '/internal/finance/reports/cash-flow', label: 'Cash Flow', allowedRoles: ['ceo', 'admin', 'director', 'accounting_leader'] },
      { to: '/internal/finance/reports/ledger', label: 'General Ledger', allowedRoles: ['ceo', 'admin', 'director', 'accounting_leader'] },
